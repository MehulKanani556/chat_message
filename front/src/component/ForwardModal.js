...
const ForwardModal = () => {
  ...
  return (
    ...
    <div className="fixed inset-0 bg-black/20 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-gradient-to-br dark:bg-primary-dark/90 rounded-[5px] shadow-2xl w-full max-w-sm transform transition-all modal_background border border-gray-200 dark:border-gray-700">
        {/* Header */}
        <div className="p-6 border-b border-gray-200 dark:border-gray-700">
          <div className="flex justify-between items-center">
            ...
            <button
              className="p-2 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-[5px] transition-colors"
              onClick={onClose}
            >
          ...
          <div className="mt-4 relative">
            <input
              ...
              className="w-full px-4 py-3 bg-white dark:bg-white/10 border border-gray-200 dark:border-gray-700 rounded-[5px]
        ...
        <div className="max-h-[300px] overflow-y-auto p-4 space-y-2 modal_scroll flex flex-col">
          {filteredUsers.map((user) => (
            <div
              key={user._id}
              className={`flex items-center p-2 hover:bg-gray-100 dark:bg-primary-dark/50 dark:hover:bg-gray-700 rounded-[5px] transition-colors cursor-pointer ${selectedUsers.includes(user._id)
        ...
        <div className="p-4 border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50 rounded-b-2xl modal_background">
          <div className="flex justify-between items-center">
            ...
            <div className="space-x-3">
              <button
                onClick={onClose}
                className="px-4 py-2 text-gray-600 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-700 rounded-[5px] transition-colors"
              >
                Cancel
              </button>
              <button
