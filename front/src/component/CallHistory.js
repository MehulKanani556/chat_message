                ...
                >
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center text-sm text-gray-600 dark:text-gray-400">
                      {isReturned ? (
                        <BsTelephoneFill className="mr-1 text-green-500 text-lg" />
                      ) : callStatus === 'missed' ? (
                        <FiPhoneMissed className="mr-1 text-red-500 " />
                      ) : callType === 'incoming' ? (
                        <FiArrowDownLeft className="mr-1 text-green-500 text-lg" />
                      ) : (
                        <FiArrowUpRight className="mr-1 text-red-500 text-lg" />
                      )}
                      <span>
