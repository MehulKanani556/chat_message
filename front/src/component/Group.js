                ...
                <div className="space-y-3">
                    {loading ? (
                        ...
                        filteredGroups.map((group) => (
                            <div
                                key={group._id}
                                className="flex items-center p-2 rounded-lg hover:bg-primary dark:hover:bg-primary cursor-pointer"
                            ...
                            >
                                ...
                                <div className="ml-3 flex-1">
                                    <span className="text-gray-700 dark:text-primary-light">{group.userName}</span>
                                    <div className="text-xs text-gray-400 dark:text-primary-light/70">
