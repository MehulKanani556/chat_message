...
const ChatList = memo(({
  ...
  const handleDragOver = (event) => {
    ...
    event.currentTarget.classList.add('bg-primary/50', 'dark:bg-primary/30');
  };
  ...
  return (
    <div
      className="w-full bg-primary-dark/5 dark:bg-primary-dark/90 h-full  relative"
      style={{
            ...
            {filteredMessageUsers
              ...
              .map((item) => {
                const lastMessage = Array.isArray(item.messages)
                  ...
                  : null;
                if (
                  lastMessage?.deletedFor?.includes(currentUser) &&
                ...
                return (
                  <div
                    key={item._id}
                    className={`px-3 py-2 hover:bg-primary hover:dark:bg-primary/85 hover:text-white cursor-pointer rounded-md mb-2 transition-colors duration-200
                  ...
                  >
                    <div className="flex items-center">
                      ...
                      <div className="relative mr-3">
                        {item?.photo &&
                          item.photo !== "null" &&
                          !item?.blockedUsers?.includes(currentUser) &&
                          (item?.profilePhoto == "Everyone" ||
