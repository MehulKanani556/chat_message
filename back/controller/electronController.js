...
const checkElectronInstalled = (req, res) => {
  try {
    ...
    const appPath = isWindows
      ? path.join(__dirname, "..", "uploads", "Host Control Setup 1.0.0.exe")
      : path.join(__dirname, "..", "uploads", "Host Control.dmg");
